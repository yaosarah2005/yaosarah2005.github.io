...
```{r}
data <- read.csv('/Users/jiayinyao/Desktop/Computational Statistics with R/yaosarah2005.github.io/tidyverse and ggplot review/Brockmann96.csv')
...
```{r}
dat.air <- read.csv(file = '/Users/jiayinyao/Desktop/Computational Statistics with R/yaosarah2005.github.io/tidyverse and ggplot review/EPA2000.csv')
```
...
```{r}
data.total <- read.csv(file = '/Users/jiayinyao/Desktop/Computational Statistics with R/yaosarah2005.github.io/tidyverse and ggplot review/totaldata.csv')
